...
export default function EditSettingsPage() {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      await axios.put(`/api/settings/${id}`, payload);
  ...
  return (
    <div className="max-w-6xl mx-auto p-8 bg-white rounded-xl shadow mt-10">
      ...
      >
        ...
        {/* Google Map */}
        <div className="md:col-span-2">
          <label className="font-medium">Google Map</label>
          <input
            {...register("googleMap")}
            className="w-full border border-gray-300 rounded-lg p-3 mt-2"
          />
        ...
        <button
          type="submit"
          disabled={loading}
          className="md:col-span-2 bg-sky-600 hover:bg-sky-700 text-white py-3 rounded-lg"
        >
